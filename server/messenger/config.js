...
const SEARCH_CONV_LIMIT = parseInt(process.env.MESSENGER_SEARCH_CONV_LIMIT || '200', 10);
const SEARCH_MSG_LIMIT = parseInt(process.env.MESSENGER_SEARCH_MSG_LIMIT || '60', 10);
